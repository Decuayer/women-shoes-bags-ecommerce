...
-- CreateEnum
CREATE TYPE "SettingType" AS ENUM ('SLIDER', 'ANNOUNCEMENT', 'MENU', 'FOOTER', 'SEO', 'GENERAL');
...
CREATE TABLE "order_items" (
    ...
    "productId" TEXT NOT NULL,
    "variantId" TEXT NOT NULL,
    "productName_tr" TEXT NOT NULL,
    "productName_en" TEXT NOT NULL,
    "variantSize" TEXT NOT NULL,
    "variantColor_tr" TEXT NOT NULL,
    "variantColor_en" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "product_variants_productId_size_color_tr_key" ON "product_variants"("productId", "size", "color_tr");
